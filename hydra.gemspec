...
Gem::Specification.new do |gem|
  ...
  gem.add_dependency 'activefedora-aggregation', '~> 0.8.1'
  gem.add_dependency 'hydra-pcdm', '~> 0.4'
  gem.add_dependency 'hydra-works', '~> 0.7.0'
  gem.add_dependency 'hydra-head', '~> 9.8.0'
