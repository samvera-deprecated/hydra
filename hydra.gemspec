...
Gem::Specification.new do |gem|
  ...
  gem.add_dependency 'fcrepo_wrapper', '~> 0.7'
  gem.add_dependency 'solr_wrapper', '~> 0.19'
  gem.add_dependency 'active-fedora', '~> 11.1'
  gem.add_dependency 'hydra-head', '~> 10.3'
  gem.add_dependency 'rails', '~> 5.0'
  gem.add_dependency 'solrizer', '~> 3.4.0'
  gem.add_dependency 'rsolr', '~> 1.1.1'
  gem.add_dependency 'blacklight', '~> 6.7'
  gem.add_dependency 'nokogiri', '~> 1.7'
  gem.add_dependency 'ldp', '~> 0.6'
  gem.add_dependency 'active-triples', '~> 0.11'
